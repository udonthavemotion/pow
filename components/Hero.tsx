...
const Hero: React.FC<HeroProps> = ({ onBookNow }) => {
  ...
  return (
    <section ref={heroRef} className="pow-hero relative w-full h-screen min-h-[600px] sm:min-h-[700px] overflow-hidden bg-[#0F0A1F]">
      ...
      <div className="pow-hero__overlay absolute inset-0 pointer-events-none z-[5]"></div>
      ...
      <div className="pow-hero__content relative z-10 h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12">
        <div className={`max-w-5xl mx-auto w-full transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <span className="pow-hero__location block text-sm sm:text-lg md:text-2xl lg:text-3xl font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.3em] text-yellow-400 mb-3 sm:mb-4 md:mb-6 drop-shadow-lg animate-fade-in-up">
          ...
          <p className="pow-hero__subtitle max-w-2xl mx-auto text-base sm:text-lg md:text-xl lg:text-3xl text-gray-100 font-semibold mb-4 sm:mb-6 md:mb-8 drop-shadow-lg px-2 sm:px-4 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="pow-stats animate-fade-in-up px-2" style={{ animationDelay: '0.4s' }}>
