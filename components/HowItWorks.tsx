    ...
    <section id="how-it-works" className="py-24 px-6 md:px-12 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center mb-16">
          <span className="text-[#FF6B00] font-bold tracking-widest uppercase text-lg mb-4 block">Simple Process</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {steps.map((step, index) => (
            <div 
              key={index}
              className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 group"
            >
              {/* Number Badge */}
              <div className="absolute -top-6 -left-6 w-16 h-16 bg-gradient-to-br from-[#FF6B00] to-[#39FF14] rounded-full flex items-center justify-center text-white font-black text-2xl font-['Bebas_Neue'] shadow-lg group-hover:scale-110 transition-transform duration-300">
                {step.number}
              </div>
              ...
              {/* Content */}
              <h3 className="text-3xl font-black text-gray-900 uppercase mb-4 font-['Bebas_Neue']">
                {step.title}
              </h3>
        ...
        <div className="text-center mt-16">
          <a 
            href="#fleet"
            className="inline-block bg-[#FF6B00] text-white px-10 py-5 font-bold uppercase tracking-widest text-lg hover:bg-[#e56000] transition-colors -skew-x-12 shadow-lg hover:shadow-xl"
          >
