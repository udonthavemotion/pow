...
function ContactPage() {
  ...
  // Per-route title + meta description. Restores the homepage defaults on unmount
  // so navigating back to "/" doesn't leave this page's title behind.
  useEffect(() => {
    const prevTitle = document.title;
    document.title = 'Book a Party Bus in Houma | Party on Wheels';
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        'Book a party bus in Houma, LA. Call (985) 856-1860 or fill out our form to reserve your ride for weddings, proms, bachelorette parties, Mardi Gras and nights out.'
      );
    }
        ...
        <section className="relative w-full h-screen min-h-[700px] lg:min-h-[800px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col items-center text-center px-4 sm:px-6">
            ...
            <div className={`flex-1 flex flex-col justify-center items-center w-full max-w-5xl mx-auto transition-all duration-1000 ease-out ${
              ...
              <h1 className="text-[2.75rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl font-black text-white leading-[0.95] sm:leading-[0.95] lg:leading-[1.05] mb-6 sm:mb-8 drop-shadow-2xl font-['Bebas_Neue'] tracking-tight">
                {!entranceDone ? (
